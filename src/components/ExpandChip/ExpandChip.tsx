...
import { ExpandChipWrapper } from './styles';
...
export const ExpandChip: React.SFC<IProps> = ({
  isExpanded,
  onClick
}: IProps) => {
  return (
    <ExpandChipWrapper isExpaned={isExpanded} onClick={event => onClick(event)}>
      <svg
        version="1.1"
