            ...
            <Row align="center">
              <Col xs={12} sm={12} md={6} lg={6}>
                ...
                <DescriptionList>
                  ...
                  <DescriptionDescription>
                    E.g all browser versions released with a greater global
                    usage of 0.3%
                  </DescriptionDescription>
          ...
          <HowToSection>
            <Row align="center">
              <Col xs={12} sm={12} md={6} lg={6} push={{ md: 6, lg: 6 }}>
                <H2>Versions</H2>
                <P>
                  After you select a range Browserful will show you the
                  respective browsers and versions.
                </P>
                <DescriptionList>
            ...
            <Row align="center">
              <Col xs={12} sm={12} md={6} lg={6}>
                ...
                <DescriptionList>
                  ...
                  <DescriptionDescription>
                    By default the version will be included if it’s within the
                    set range
                  </DescriptionDescription>
